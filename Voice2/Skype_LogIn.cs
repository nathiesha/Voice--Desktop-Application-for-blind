...
namespace Voice2
{
    public partial class Skype_LogIn : Form
    {
        ...
        {
            InitializeComponent();
            DataTable dt = GetDataTable(@"G:\c users\Desktop\sem 5\SEP\SkypeUserNames1.txt");//displaying user names in data tables
        ...
        private void Skype_LogIn_Shown(object sender, EventArgs e)
        {
            SpeechRecognitionEngine recognizer = new SpeechRecognitionEngine();
            lines2 = System.IO.File.ReadAllLines(@"G:\c users\Desktop\sem 5\SEP\SkypeUserNames.txt");
            synth.SetOutputToDefaultAudioDevice();
            synth.Speak("Log In to Skype");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Skype_Contact form6 = new Skype_Contact(position, next);//new form email options
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            SystemSounds.Beep.Play();//play a beep sound
            //direct to the next window
            Skype_Call form6 = new Skype_Call(next);//new form email options
            this.Hide();//hide this form
            form6.Closed += (s, args) => this.Close();
            form6.Show();//show new form
        }
        ...
        private void button1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            Skype_LogIn form6 = new Skype_LogIn();//new form email login
            this.Hide();//hide this form
            form6.Closed += (s, args) => this.Close();
            form6.Show();//show new form
        }
